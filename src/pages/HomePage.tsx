  ...
  return <div className="home-page">
    <section className="hero">
      <div className="hero-copy">
        ...
        <div className="workspace-status"><span className="pulse" /> Auto-saved locally{cloudStatus === 'local' ? ' · this device only' : cloudStatus === 'synced' ? ' · live across devices' : ' · waiting to sync'} · {state.senses.length} senses · {state.graphs.length} graphs</div>
      </div>
